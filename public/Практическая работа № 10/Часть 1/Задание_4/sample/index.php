...
<body>
	...
	<?php
		...
		*/
		...
		// Проверяем, передан ли параметр view, иначе задаем значение по умолчанию 'dump'
		$view = isset($_GET['view']) ? htmlspecialchars($_GET['view']) : 'dump';
	?>

	<!-- Подставляем PHP переменную с GET-параметром в атрибут action -->
